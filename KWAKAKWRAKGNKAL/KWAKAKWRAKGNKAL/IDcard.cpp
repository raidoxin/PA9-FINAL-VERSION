...
void IDcard::draw(sf::RenderWindow & window)
{
	...
	sf::RectangleShape card(sf::Vector2f(770, 900));
	...
	static_info_EXPD.setPosition(0, 400);
	static_info_COUNTRY.setPosition(0, 450);
	card.setFillColor(sf::Color(30,0,200,255));
	card.setPosition(0, 0);
	//for id class	
	sf::Text static_info_ID_EXP("ID EXP DATE: ", bold, 30);
	sf::Text static_info_CITY("CITY: ", bold, 30);
	static_info_ID_EXP.setPosition(0, 500);
	static_info_CITY.setPosition(0, 550);
	...
	IDno_draw.setPosition(250, 50);
	DOB_draw.setPosition(250, 100);
	sex_draw.setPosition(250, 150);
	firstN_draw.setPosition(250, 200);
	lastN_draw.setPosition(250, 250);
	height_draw.setPosition(250, 300);
	weight_draw.setPosition(250, 350);
	date_draw.setPosition(250, 400);
	country_draw.setPosition(250, 450);
	id_exp_draw.setPosition(250, 500);
	city_draw.setPosition(250, 550);
	//	
