...
void visa::draw(sf::RenderWindow & window)
{
	...
	static_info_SEX.setPosition(0, 100);
	static_info_FIRST.setPosition(0, 150);
	static_info_LAST.setPosition(0, 200);
	static_info_HEIGHT.setPosition(0, 300);
	static_info_WEIGHT.setPosition(0, 350);
	static_info_EXPD.setPosition(0, 400);
	static_info_COUNTRY.setPosition(0, 250);
	static_info_DEST_COUNTRY.setPosition(0, 300);
	static_info_DEST_CITY.setPosition(0, 350);
	static_info_VISA_TYPE.setPosition(0, 400);
	...
	sex_draw.setPosition(500, 100);
	firstN_draw.setPosition(500, 150);
	lastN_draw.setPosition(500, 200);
	height_draw.setPosition(500, 300);
	weight_draw.setPosition(500, 350);
	date_draw.setPosition(500, 400);
	country_draw.setPosition(500, 250);
	dest_country_draw.setPosition(500,300l);
	dest_city_draw.setPosition(500, 350);
	visa_type_draw.setPosition(500, 400);
	//	
