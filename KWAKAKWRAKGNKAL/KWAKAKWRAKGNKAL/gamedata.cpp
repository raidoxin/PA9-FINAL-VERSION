...
gamedata::gamedata() {
	...
	citystates[2][3] = "San Aurica";
	citystates[3][3] = "Arsennal";
...
void gamedata::display_choice_deny(sf::RenderWindow & window)
{
	passport_dox.draw2(window);
	passport_dox.draw2(window);
}

void gamedata::display_choice_accept(sf::RenderWindow & window)
{
	passport_dox.draw3(window);
	passport_dox.draw3(window);
}
